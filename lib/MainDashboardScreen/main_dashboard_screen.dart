...
import 'package:epic_inviation/selfless_screens/being_selfless_at_aao.dart';
                ...
                children: [
                  Row(
                    ...
                    children: [Padding(
                      ...
                      child: Image.asset('assets/logo.png', height: 80,width: 70,),
                    ),
                    Padding(
                    ...
                    child: Material(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.only(topLeft: Radius.elliptical(10, 15)),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(child: MyCard(imageUrl: './assets/profile.png', title: "My Profile"),
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context){
                      ...
                      // ),
                      // InkWell(child: MyCard1(imageUrl: './assets/lastlogo.png',),
                      //   onTap: (){
                      //     Navigator.of(context).push(MaterialPageRoute(builder: (context){
                      //       return const BeingSelflessMainScreen();
                      //     }));
                      //   },
                      //
                      // )
