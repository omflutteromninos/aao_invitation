        ...
        Container(
          ...
          child: Column(
            ...
            children:  [
              ...
              Image.asset('assets/logo.png',height: 128,width: 123,),

              const SizedBox(height: 32,),
              FittedBox(
                fit: BoxFit.fitWidth,

                child: Text('Enter your 6 digit code', textAlign: TextAlign.left, style: TextStyle( color: appblack,
                  fontSize: 32,
              ...
              const SizedBox(height: 32,),
              Text('Enter the code sent to you via SMS', textAlign: TextAlign.left, style: TextStyle(
                  color: appblack,
                  fontSize: 16,
              ),),
              SizedBox(height: 20,),
