...
class Buttonl extends StatelessWidget {
  Buttonl({Key? key,required this.data, required this.color, required this.TextColor}) : super(key: key);
  String data;
  Color color;
  Color TextColor;
...
class statstabButton extends StatelessWidget {
  statstabButton({Key? key, required this.data,required this.color, required this.textColor}) : super(key: key);
  String data;
  Color color;
  Color textColor;
