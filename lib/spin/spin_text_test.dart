...
class FinalSpinScreen1 extends StatefulWidget {
  @override
  _FinalSpinScreen1State createState() => _FinalSpinScreen1State();
}

class _FinalSpinScreen1State extends State<FinalSpinScreen1> {
                                            ...
                                            child: Stack(
                                              children: [
                                                ...
                                                Positioned(
                                                    ...
                                                    child: RotatedBox(
                                                  quarterTurns: 1,
                                                  child: Text('postion 1',style: TextStyle(color: Colors.yellow,fontSize: 10,
