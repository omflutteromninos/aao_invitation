    ...
    return Container(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Invite Status', style: TextStyle(color: Colors.black,
            fontSize: 24,
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              //SizedBox(height: 10,),
              ListTile(
                leading: Text('Pending Invitations', style: GoogleFonts.montserrat(
                    textStyle: TextStyle(
                      color: appblack,
                      fontSize: 20,
                      fontFamily: "Montserrat",
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text('08/07/2022', style: TextStyle(color: Colors.black, fontSize: 12),),
                    ],
                  ),
                  Column(
                    children: [
                      ...
                      Text('Recieved', style: TextStyle(color: Colors.black, fontSize: 12),),
                    ],
                  ...
                  Column(
                    children: [
                      ...
                      Text('2:01:32', style: TextStyle(color: Colors.black, fontSize: 12),),
                    ],
                  )
                ],
              ),
